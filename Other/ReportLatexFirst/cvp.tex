...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Meta informations:
\newcommand{\trauthor}{Danu Caus}
\newcommand{\trtype}{Seminar Paper} %{Seminararbeit} %{Proseminararbeit}
\newcommand{\trcourse}{Computer Vision Project}
\newcommand{\trtitle}{Active Perception}
\newcommand{\trmatrikelnummer}{7014833}
\newcommand{\tremail}{7caus@informatik.uni-hamburg.de}
\newcommand{\trarbeitsbereich}{Computer Vision Group, CV}
\newcommand{\trdate}{21.06.2019}
